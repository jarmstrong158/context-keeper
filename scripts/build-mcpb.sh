...
cp "$ROOT/store_paths.py"     "$STAGE/server/store_paths.py"
cp "$ROOT/scope_rules.py"     "$STAGE/server/scope_rules.py"
cp "$ROOT/ranking.py"     "$STAGE/server/ranking.py"
cp "$ROOT/mojibake.py"    "$STAGE/server/mojibake.py"
cp "$ROOT/quality_checks.py" "$STAGE/server/quality_checks.py"
